 ...
 */
public class BotonActualizarTablaGuia02 extends DefaultCellEditor {
    ...
    public BotonActualizarTablaGuia02(JCheckBox checkBox) {
        super(checkBox);
        button = new JButton();
    ...
    //----------------------------------------------------------------------------
    //----------------------------------------------------------------------------
    private Guia02 getItemsLista(JTable tabla, int fila) {
