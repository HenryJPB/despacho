 ...
 * @author henrypb
 */
public class RenderFormatoTabla1 {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,boolean hasFocus, int row, int column) {
            ...
            if (value == null) {
               ...
               //valorCelda.setHorizontalAlignment(SwingConstants.CENTER);
                ...
                celda.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,###,##0.000")))); 
            }
            /*
            if (row == 1) {
